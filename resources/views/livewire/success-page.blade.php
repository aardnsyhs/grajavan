        ...
        <div
            ...
            <div>
                <h1 class="px-4 mb-8 text-2xl font-semibold tracking-wide text-gray-700 dark:text-gray-300 ">
                    Terimakasih. Pesanan kamu sudah diterima. </h1>
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Kurir</p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                                        {{ Number::currency(0, 'IDR') }}</p>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Kurir</h2>
